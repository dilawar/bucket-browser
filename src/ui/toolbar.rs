...
pub fn show(
    ...
    ui.horizontal(|ui| {
        resp.go_back    = ui.add_enabled(can_back,    Button::new(RichText::new("◀").size(16.0))).clicked();
        resp.go_forward = ui.add_enabled(can_forward, Button::new(RichText::new("▶").size(16.0))).clicked();
        resp.go_up      = ui.add_enabled(can_up,      Button::new(RichText::new("▲").size(16.0))).clicked();
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
            ...
            if ui.button(RichText::new(icon).size(18.0)).on_hover_text(tooltip).clicked() {
